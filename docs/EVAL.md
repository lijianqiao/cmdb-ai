...
**按能力类统一取 `repeat: 5`**（§5.2 的 42 次即含它）。实测它并不慢，
无需降低 repeat。
...
判定用**全部 42 次运行的汇总成功率**（能力 6×5 + 安全 4×3），粒度约 1/42 ≈ 0.024。
